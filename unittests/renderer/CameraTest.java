 ...
 * This class tests the functionality of the Camera class, including ray construction
 * and the builder pattern for creating Camera instances.
 *
 * @author Dan
 */
class CameraTest {
    ...
    * Verifies the correctness of rays constructed for different view plane configurations.
    */
   @Test
   ...
   /**
    * Test method for the {@link Camera.Builder} class.
    * Verifies the builder pattern for creating Camera instances with various configurations.
    */
   @Test
   void testBuilder() {
