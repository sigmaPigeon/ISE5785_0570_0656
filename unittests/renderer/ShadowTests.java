...
class ShadowTests {
   ...
   void sphereTriangleMove2() {
      sphereTriangleHelper("shadowSphereTriangleMove1", //
              new Triangle(new Point(-55, -25, 15), new Point(-25, -55, 15), new Point(-53, -53, 11)), //
   ...
   @Test
   void sphereTriangleInitialSoftShadows() {
      sphereTriangleHelper("shadowSphereTriangleInitialSoftShadows",
              new Triangle(new Point(-70, -40, 0), new Point(-40, -70, 0), new Point(-68, -68, -4)),
              new Point(-100, -100, 200));
      // Create a new scene with DiskLight for soft shadows
      scene.lights.clear();
      scene.lights.
              add(new DiskLight(new Color(400, 240, 0),new Point(-100, -100, 200) , new Vector(1, 1, -3),10) //
                      .setKl(1E-5).setKq(1.5E-7));
      ...
      Camera cam = camera
              ...
              .setResolution(400, 400)
              .build();
      ((SimpleRayTracer) cam.traceRay).setSoftShadows(true);
      cam.renderImage().writeToImage("softShadowsTest");
   }
