...
// Stronger point light
    ...
    void
    complexSceneWithManyGeometriesAndLightsWithBVHMP1() {
        // Add 10 geometries with much darker emission
        scene.geometries.add(
                new Sphere(new Point(0, 0, 0), 20)
                        .setEmission(new Color(20, 20, 50))
...
// Lower ambient light
        ...
        Camera camera = cameraBuilder
                ...
                .setResolution(800, 800)
                .setRayTracer(scene, RayTracerType.SIMPLE)
                .setMultithreading(-1) // Use 8 threads for rendering
                .enableBVH()
                .build();
        ...
        camera.renderImage()
                .writeToImage("complexSceneWithManyGeometriesAndLightsWithBVHMP1");
    }

    @Test
    @Disabled
    void complexSceneWithManyGeometriesAndLightsNoSoftBVHMP1() {
        // Add 10 geometries with much darker emission
        scene.geometries.add(
                new Sphere(new Point(0, 0, 0), 20)
                        .setEmission(new Color(20, 20, 50))
...
// Lower ambient light
        ...
        ((SimpleRayTracer) camera.traceRay).setSoftShadows(false);

        camera.renderImage()
                .writeToImage("complexSceneWithManyGeometriesAndLightsNoSoftBVHMP1");
    }

    @Test
    void complexSceneWithManyGeometriesAndLightsNoSoftMP1() {
        // Add 10 geometries with much darker emission
        scene.geometries.add(
                new Sphere(new Point(0, 0, 0), 20)
                        .setEmission(new Color(20, 20, 50))
...
// Lower ambient light
        ...
        camera.renderImage()
                .writeToImage("complexSceneWithManyGeometriesAndLightsNoSoftMP1");
    }
